...
type Robot_Status struct {
	...
	FlWheelSpeed           *float32               `protobuf:"fixed32,7,opt,name=fl_wheel_speed,json=flWheelSpeed" json:"fl_wheel_speed,omitempty"`
	BlWheelSpeed           *float32               `protobuf:"fixed32,8,opt,name=bl_wheel_speed,json=blWheelSpeed" json:"bl_wheel_speed,omitempty"`
	BrWheelSpeed           *float32               `protobuf:"fixed32,9,opt,name=br_wheel_speed,json=brWheelSpeed" json:"br_wheel_speed,omitempty"`
	FrWheelSpeed           *float32               `protobuf:"fixed32,10,opt,name=fr_wheel_speed,json=frWheelSpeed" json:"fr_wheel_speed,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *Robot_Status) GetFlWheelSpeed() float32 {
	if x != nil && x.FlWheelSpeed != nil {
		return *x.FlWheelSpeed
	}
	return 0
}

func (x *Robot_Status) GetBlWheelSpeed() float32 {
	if x != nil && x.BlWheelSpeed != nil {
		return *x.BlWheelSpeed
	}
	return 0
}

func (x *Robot_Status) GetBrWheelSpeed() float32 {
	if x != nil && x.BrWheelSpeed != nil {
		return *x.BrWheelSpeed
	}
	return 0
}

func (x *Robot_Status) GetFrWheelSpeed() float32 {
	if x != nil && x.FrWheelSpeed != nil {
		return *x.FrWheelSpeed
	}
	return 0
}
...
const file_pi_to_mw_proto_rawDesc = "" +
	...
	"\tcap_power\x18\x06 \x02(\rR\bcapPower\x12$\n" +
	"\x0efl_wheel_speed\x18\a \x01(\x02R\fflWheelSpeed\x12$\n" +
	"\x0ebl_wheel_speed\x18\b \x01(\x02R\fblWheelSpeed\x12$\n" +
	"\x0ebr_wheel_speed\x18\t \x01(\x02R\fbrWheelSpeed\x12$\n" +
	"\x0efr_wheel_speed\x18\n" +
	" \x01(\x02R\ffrWheelSpeed\"w\n" +
	"\vBall_Status\x12 \n" +
